...
public class AICreationScript : MonoBehaviour
{
    ...
    private void SpawnEntities()
    {
        ...
        Sniper1 = Instantiate(SniperPrefab, SpawnLocations[2], Quaternion.identity);
        Sniper1.AddComponent<SniperScript>();
        Sniper2 = Instantiate(SniperPrefab, SpawnLocations[3], Quaternion.identity);
        Sniper2.AddComponent<SniperScript>();
        Sniper3 = Instantiate(SniperPrefab, SpawnLocations[4], Quaternion.identity);
